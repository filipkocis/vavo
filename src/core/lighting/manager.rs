...
impl LightAndShadowManager {
    ...
    pub fn update(&mut self, lights: &mut [Light], ctx: &mut SystemsContext) {
        ...
        assert_eq!(
            point_lights % 6,
            0,
            "Point lights must be a multiple of 6, one for each cube face"
        );
    ...
    pub fn create_view(&self, light: &Light) -> wgpu::TextureView {
        ...
        if light.is_directional() {
            self.directional_shadow_map
                .create_view(layer, count, dimension)
        } else if light.is_point() {
    ...
    pub unsafe fn unsafe_create_view(
        &self,
        ...
        match light_type {
            ...
            _ => panic!(
                "Could not create view, invalid light type: {:#?}",
                light_type
            ),
        }
    }
    ...
    fn create_render_asset(
        ...
        BindGroup::build("LightAndShadowManager")
            ...
            .add_custom(
                ...
                binding_type,
                None,
                wgpu::BindingResource::TextureView(&self.directional_shadow_map.create_view(
                    0,
                    None,
            ...
            .add_custom(
                ...
                cube_binding_type,
                None,
                wgpu::BindingResource::TextureView(&self.point_shadow_map.create_view(
                    0,
                    None,
            ...
            .add_custom(
                ...
                binding_type,
                None,
                wgpu::BindingResource::TextureView(&self.spot_shadow_map.create_view(
                    0,
                    None,
                    Some(wgpu::TextureViewDimension::D2Array),
                )),
